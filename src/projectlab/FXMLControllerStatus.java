...
public class FXMLControllerStatus implements Initializable {
    ...
    public ObservableList<Status> atualizaTabela() {
        ...
        String sql = "select paid, data, indicador,responsavel, status from diagramalab d  where paid =" + id;
        ...
        try {
            ...
            Logger.getLogger(FXMLControllerStatus.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public ObservableList<Status> atualizaTabelaAoVivo() {
        ...
        String sql = "select paid, indicador,responsavel, status from diagramalab d where responsavel like  '" + responsavel + "%' order by paid ";
...
//passa variavel para outro controller
    ...
    public void buscaAnalise() {
        ...
        String sql = "SELECT COUNT(*)  FROM diagramalab d where Status = 'Em Aberto' and responsavel like '" + responsavel + "%'";
        try {
            PreparedStatement prs = getConexao().getConnection().prepareStatement(sql);
            ResultSet rs = prs.executeQuery();
    ...
    public void buscaFechado() {
        ...
        String sql = "SELECT COUNT(*)  FROM diagramalab d where Status = 'Encerrada' and responsavel like '" + responsavel + "%'";
        try {
            PreparedStatement prs = getConexao().getConnection().prepareStatement(sql);
            ResultSet rs = prs.executeQuery();
    ...
    public void buscaAndamento() {
        ...
        String sql = "SELECT COUNT(*)  FROM diagramalab d where Status = 'Em Andamento' and responsavel like '" + responsavel + "%'";
        try {
            PreparedStatement prs = getConexao().getConnection().prepareStatement(sql);
            ResultSet rs = prs.executeQuery();
