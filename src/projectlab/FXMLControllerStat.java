 ...
 */
public class FXMLControllerStat implements Initializable {
    ...
    public ObservableList<Status> atualizaTabela() {
        ...
        try {
            String sql = "select paid, data, indicador,responsavel, status, encerramento from diagramalab d  where paid =" + id + " and responsavel = '" + responsavel + "'";
